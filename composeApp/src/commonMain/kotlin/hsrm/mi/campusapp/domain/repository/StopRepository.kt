...
object StopRepository {
    val stops = listOf<Stop>(
        Stop("A=1@O=Rüsselsheim Hochschule-Rhein-Main@X=8422371@Y=49985453@U=80@L=3014366@p=1767293043@","Kurt-Schumacher-Ring", "Hochschule Rhein-Main",  Position( 8.218216, 50.081457)),
