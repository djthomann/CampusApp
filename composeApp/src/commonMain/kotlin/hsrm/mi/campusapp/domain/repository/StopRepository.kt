...
object StopRepository {
    val stops = listOf<Stop>(
        ...
        Stop("A=1@O=Wiesbaden Klarenthaler Straße@X=8226649@Y=50077961@U=80@L=3025274@p=1767379514@","Kurt-Schumacher-Ring", "Klarenthaler Straße",  Position( 8.218216, 50.081457)),
